...
class ServiceDetailsDesktop extends StatelessWidget {
  ...
  const ServiceDetailsDesktop({Key? key, required this.details, required this.serviceTitle})
      : super(key: key);
  @override
...
class ServiceDetailsDescription extends StatelessWidget {
  ...
  const ServiceDetailsDescription({Key? key, required this.desc, required this.serviceTitle})
      : super(key: key);
  @override
  Widget build(BuildContext context) {
    final _themeProvider = Provider.of<ThemeProvider>(context);
